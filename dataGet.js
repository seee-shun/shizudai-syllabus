...
const fs = require('fs');
// var mainObj = {};
var mainObj = JSON.parse(fs.readFileSync('./data2021.json', 'utf8'));
...
(async () => {
  ...
  await page.select('select[name="syllabusTitleID"]', '2129'); //2021年度：2143,2137,2130,2132,2129 2020年度：2125,2121,2119,2111,2114,2112　2019年度:2108,2104,2102,2094,2097,2095
...
//   await Promise.all(promiseArray);
  ...
  fs.writeFile('data2021.json', JSON.stringify(mainObj), (err) => {
    if (err) throw err;
    console.log('done');
  });
